...
add_action( 'acf/include_fields', function() {
	...
	acf_add_local_field_group( array(
		...
		'fields' => array(
			...
			array(
				'key' => 'field_647480b966f67',
				'label' => 'Reviews',
				'name' => 'review_repeater',
				'aria-label' => '',
				'type' => 'repeater',
				'instructions' => '',
				'required' => 0,
				...
				'sub_fields' => array(
					array(
						...
						'prepend' => '',
						'append' => '',
						'parent_repeater' => 'field_647480b966f67',
					),
					array(
						'key' => 'field_647480b997596',
						'label' => 'Review',
						'name' => 'comment_review',
						'aria-label' => '',
						'type' => 'textarea',
